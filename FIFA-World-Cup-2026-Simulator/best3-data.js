const best3CsvContent = `
No.,"Third-placed teams
advance from groupsvte","Third-placed teams
advance from groupsvte","Third-placed teams
advance from groupsvte","Third-placed teams
advance from groupsvte","Third-placed teams
advance from groupsvte","Third-placed teams
...
function buildThirdPlacePairings(csvText) {
    ...
    for (const line of lines) {
        ...
        const isValid = Object.values(matchups).every(v => v && v.startsWith('3'));        
        if (isValid) {
            map[key] = matchups;
        }
    }
...
const thirdPlacePairings = buildThirdPlacePairings(best3CsvContent);
